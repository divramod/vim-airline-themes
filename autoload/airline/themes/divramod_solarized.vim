let g:airline#themes#divramod_solarized#palette = {}

function! airline#themes#divramod_solarized#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  let s:background           = get(g:, 'airline_divramod_solarized_bg', &background)
  let s:ansi_colors          = get(g:, 'divramod_solarized_termcolors', 16) != 256 && &t_Co >= 16 ? 1 : 0
  let s:use_green            = get(g:, 'airline_divramod_solarized_normal_green', 0)
  let s:dark_inactive_tab    = get(g:, 'airline_divramod_solarized_dark_inactive_background', 0)
  let s:dark_text            = get(g:, 'airline_divramod_solarized_dark_text', 0)
  let s:dark_inactive_border = get(g:, 'airline_divramod_solarized_dark_inactive_border', 0)
  let s:enable_command_color = get(g:, 'airline_divramod_solarized_enable_command_color', 0)
  let s:tty                  = &t_Co == 8
  ...
  if s:ansi_colors && get(g:, 'divramod_solarized_base16', 0)

    let maincolor = 0
    let fileColorswitchMaincolor = '~/.colorswitch.maincolorfg'
    if !empty(expand(glob(fileColorswitchMaincolor)))
        for line in readfile(glob(fileColorswitchMaincolor))
            let maincolor = line
        endfor
    endif
    ...
    let s:base0   = {'t': 15, 'g': "#839496"}  " Base 04
    let s:base1   = {'t': 7,  'g': "#93a1a1"}  " Base 05
    let s:base2   = {'t': 10, 'g': "#eee8d5"}  " Base 06
  ...
  " Inactive, according to VertSplit in divramod_solarized
  ...
  let g:airline#themes#divramod_solarized#palette.accents = {
        \ 'red': s:NFa,
        \ }

  let g:airline#themes#divramod_solarized#palette.inactive = airline#themes#generate_color_map(
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]])
  let g:airline#themes#divramod_solarized#palette.inactive_modified = {
        \ 'airline_c': [s:NMi[0].g, '', s:NMi[0].t, '', s:NMi[2]]}

  let g:airline#themes#divramod_solarized#palette.normal = airline#themes#generate_color_map(
        \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
        \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
        \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]])

  let g:airline#themes#divramod_solarized#palette.normal.airline_warning = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#divramod_solarized#palette.normal.airline_error = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#divramod_solarized#palette.normal_modified = {
        \ 'airline_c': [s:NM[0].g, s:NM[1].g,
        \ s:NM[0].t, s:NM[1].t, s:NM[2]]}

  let g:airline#themes#divramod_solarized#palette.normal_modified.airline_warning =
        \ g:airline#themes#divramod_solarized#palette.normal.airline_warning

  let g:airline#themes#divramod_solarized#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#divramod_solarized#palette.insert.airline_warning =
        \ g:airline#themes#divramod_solarized#palette.normal.airline_warning

  let g:airline#themes#divramod_solarized#palette.insert_modified = {
        \ 'airline_c': [s:IM[0].g, s:IM[1].g,
        \ s:IM[0].t, s:IM[1].t, s:IM[2]]}

  let g:airline#themes#divramod_solarized#palette.insert_modified.airline_warning =
        \ g:airline#themes#divramod_solarized#palette.normal.airline_warning

  let g:airline#themes#divramod_solarized#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#divramod_solarized#palette.visual.airline_warning =
        \ g:airline#themes#divramod_solarized#palette.normal.airline_warning

  let g:airline#themes#divramod_solarized#palette.visual_modified = {
        \ 'airline_c': [s:VM[0].g, s:VM[1].g,
        \ s:VM[0].t, s:VM[1].t, s:VM[2]]}

  let g:airline#themes#divramod_solarized#palette.visual_modified.airline_warning =
        \ g:airline#themes#divramod_solarized#palette.normal.airline_warning

  let g:airline#themes#divramod_solarized#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#divramod_solarized#palette.replace.airline_warning =
        \ g:airline#themes#divramod_solarized#palette.normal.airline_warning

  let g:airline#themes#divramod_solarized#palette.replace_modified = {
        \ 'airline_c': [s:RM[0].g, s:RM[1].g,
        \ s:RM[0].t, s:RM[1].t, s:RM[2]]}

  let g:airline#themes#divramod_solarized#palette.replace_modified.airline_warning =
        \ g:airline#themes#divramod_solarized#palette.normal.airline_warning
  ...
  if s:enable_command_color
    let g:airline#themes#divramod_solarized#palette.commandline = airline#themes#generate_color_map(
    ...
    let g:airline#themes#divramod_solarized#palette.commandline.airline_warning =
          \ g:airline#themes#divramod_solarized#palette.normal.airline_warning

    let g:airline#themes#divramod_solarized#palette.commandline_modified = {
          \ 'airline_c': [s:RM[0].g, s:RM[1].g,
          \ s:RM[0].t, s:RM[1].t, s:RM[2]]}
  endif

  let g:airline#themes#divramod_solarized#palette.tabline = {}

  let g:airline#themes#divramod_solarized#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, (s:dark_inactive_tab ? s:I3[0].t : s:I2[1].t), s:I2[2]]

  let g:airline#themes#divramod_solarized#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#divramod_solarized#refresh()
